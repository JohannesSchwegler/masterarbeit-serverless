...
export default class ResponseModel {
  static generateSuccessResponse = (key: string, data: any) => {
    new ResponseModel({ [key]: data }, StatusCode.OK);
  };

  static setErrorOrResponse = (error: any, message) => {
    return error instanceof ResponseModel
      ? error
      : new ResponseModel({}, StatusCode.ERROR, message);
  };
